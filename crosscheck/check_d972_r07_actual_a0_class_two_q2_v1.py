...
CHECK_SCHEMA = SCHEMA + "/checker-verdict/v1"
CHECKPOINT_SCHEMA = SCHEMA + "/checkpoint/v1"
COMPLETE = "R07_ACTUAL_A0_CLASS_TWO_Q2_V1_COMPLETE"
UNKNOWN_RESOURCE = "UNKNOWN_RESOURCE"
REJECTED = "REJECTED"
CHECKER_LINE = "R07_ACTUAL_A0_CLASS_TWO_Q2_V1_CHECKER"
BLOCKS = ("H1", "H2", "P")
MODULUS = 3

PRODUCER_PIN = (
    "search/d972_r07_actual_a0_class_two_q2_v1.py", 50355,
...
def check_complete(args: argparse.Namespace, budget: Budget,
    ...
    require(type(owners) is dict and owners.get("task193_v3") == task193_id and
    ...
    return seal({
        ...
        "task193_v3": task193_id, "task198": authority.identity,
...
def parser() -> argparse.ArgumentParser:
    ...
    ap.add_argument("--output", default="ci/out/d972_r07_actual_a0_class_two_q2_v1.checker.json")
