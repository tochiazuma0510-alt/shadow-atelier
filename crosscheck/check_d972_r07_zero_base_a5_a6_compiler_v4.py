#!/usr/bin/env python3
"""Independent checker for the R07 direct-relator A5/A6 v4 receipt.
...
CHECKER_LINE = "R07_ZERO_BASE_A5_A6_COMPILER_V4_CHECKER"
...
def load_helper() -> types.ModuleType:
    ...
    module = types.ModuleType("r07_task198_v14_arithmetic_for_a5_v4")
