#!/usr/bin/env python3
"""Independent Task451 dual-anchored closed-batch replay."""
from __future__ import annotations
import argparse,hashlib,importlib.util,json
from pathlib import Path
ROOT=Path(__file__).resolve().parents[1];SCHEMA="d972-r07-a0-dual-anchored-active-batch/v1";CP_SCHEMA=SCHEMA+"/checkpoint";MARKER="R07_A0_DUAL_ANCHORED_ACTIVE_BATCH_V1_CHECKER"
...
def self_test():
    anchor="a"*64;row={"kind":"correction","selector_cursor":[1,0,"00",0],"anchor_scalar":1,"pre_rank":51,"post_rank":52,"pivot":"aa","exact_exponent_pair":[72,0]};batch={"batch":1,"anchor_rank":51,"anchor_dual_digest":anchor,"anchor_remainder_digest":"b"*64,"rows":[row],"row_count":1,"post_rank":52,"post_remainder_digest":"c"*64,"post_dual_digest":"d"*64,"closed":True};rejected=[]
    def toy(x):
    ...
    need(len(rejected)==10,"mutations");return {"status":"PASS","mutation_rejections":rejected,"toy_batch_rows":1,"anchor_dual_reused":True,"frozen_prefix_semantic_replay":True,"max_rises_exact":64}
def main(argv=None):
