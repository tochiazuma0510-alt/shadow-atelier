#!/usr/bin/env python3
"""Task373/v5 checker-side independent rows 1--7 authority trace.
...
def load_fixture(owner: AuthenticatedOwner, counter: Counter, argument: str) -> dict[str, Any]:
    ...
    if type(seal) is not str or seal != FIXTURE_SELF or seal != digest_object(body, counter, 1_000_000, "fixture_body") or fixture.get("schema") != SCHEMA + "/authority-fixture/v5": raise CheckerInputStop("checker:fixture:self_seal")
