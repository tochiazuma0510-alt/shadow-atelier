#!/usr/bin/env python3
"""Checker successor pinned to the replayable v17 production wrapper."""
...
_REPLACEMENTS = (
    (b"search/d972_r07_history_free_positive_fast_resume_v13.py",
     b"search/d972_r07_history_free_positive_fast_resume_v17.py"),
    (b"147409", b"2451"),
    (b"4d1be83fefbb1a1c0b23010825c0013b80650439b714dce7e35a6e0f53a2ff2a",
     b"8d88068960d71a7a5dffe93aeb7f8dd872e5b4e9b2ced181a15c7a1db8047ed1"),
)

_patched = _BASE.read_bytes()
if (len(_patched) != _BASE_BYTES or
        hashlib.sha256(_patched).hexdigest() != _BASE_SHA256):
    raise SystemExit("v17 checker frozen v13 owner drift")
for _old, _new in _REPLACEMENTS:
    if _patched.count(_old) != 1:
        raise SystemExit("v17 checker producer-pin substitution cardinality")
    _patched = _patched.replace(_old, _new)
for _old, _new in _REPLACEMENTS:
    if _patched.count(_old) != 0:
        raise SystemExit("v17 checker producer-pin substitution failed")
