...
SCHEMA = "d972-r07-joint-slice-kernel-general/v7"
SELF = SCHEMA + "/selftest"
FIXTURE = "search/certs/d972_r07_joint_slice_kernel_general_selftest_v7_20260828.json"
FIXTURE_SEAL = "literal-static-fixture-v7"
PASS = "R07_JOINT_SLICE_KERNEL_GENERAL_V7_CHECKER_SELFTEST_PASS"
...
def main(argv=None):
    ...
    try:
        ...
        verdict = {"schema": SCHEMA + "/checker-verdict/v7", "accepted": False, "independent": True, "status": "UNKNOWN_INPUT", "terminal": "UNKNOWN_INPUT", "reason": str(exc), "producer_imported": False}
    ...
    if verdict.get("accepted"):
        ...
        print("R07_JOINT_SLICE_KERNEL_GENERAL_V7_CHECKER_TERMINAL " + verdict["terminal"])
