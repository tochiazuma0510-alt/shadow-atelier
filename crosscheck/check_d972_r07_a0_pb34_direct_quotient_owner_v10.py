#!/usr/bin/env python3
"""Independent, bounded checker for the v10 candidate envelope."""
import argparse,gzip,hashlib,json,marshal
from pathlib import Path
ROOT=Path(__file__).resolve().parents[1]
SCHEMA="d972-r07-a0-pb34-direct-quotient-owner/v10"
...
def main():
 ...
 if a.self_test:print("R07_A0_PB34_DIRECT_QUOTIENT_CHECKER_V10_PASS "+json.dumps(self_test(),sort_keys=True,separators=(",",":")));return 0
 ...
 print("R07_A0_PB34_DIRECT_QUOTIENT_CHECKER_V10_PASS "+json.dumps(out,sort_keys=True,separators=(",",":")));return 0
if __name__=="__main__":
 try:raise SystemExit(main())
 except (Reject,KeyError,IndexError,TypeError,ValueError,OSError) as e:print("R07_A0_PB34_DIRECT_QUOTIENT_CHECKER_V10_FAIL "+str(e));raise SystemExit(1)
