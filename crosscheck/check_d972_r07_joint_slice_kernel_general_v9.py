...
PASS = "R07_JOINT_SLICE_KERNEL_GENERAL_V9_CHECKER_SELFTEST_PASS"
...
def main(argv=None):
    ...
    try:
        ...
        verdict = {"schema": SCHEMA + "/checker-verdict/v9", "accepted": False, "independent": True, "status": "UNKNOWN_INPUT", "terminal": "UNKNOWN_INPUT", "reason": str(exc), "producer_imported": False}
    ...
    if verdict.get("accepted"):
        ...
        print("R07_JOINT_SLICE_KERNEL_GENERAL_V9_CHECKER_TERMINAL " + verdict["terminal"])
