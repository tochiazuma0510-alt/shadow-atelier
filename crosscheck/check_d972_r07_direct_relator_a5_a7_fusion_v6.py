...
The v6 producer is never imported.  Selected Schreier ancestry is replayed
...
SCHEMA = "d972-r07-direct-relator-a5-a7-fusion/v6"
CHECK_SCHEMA = SCHEMA + "/checker-verdict/v6"
...
CHECKER_LINE = "R07_DIRECT_RELATOR_A5_A7_FUSION_V6_CHECKER"
...
PRODUCER_PIN = (
    "search/d972_r07_direct_relator_a5_a7_fusion_v6.py", 57826,
    "da9e8ca8e5ea2c30e92eef2d1dba772a0aa4d3eed9d894c7441c40cb49ac6441")
V4_PIN = (
...
BASE_PIN = (
    "search/d972_r07_zero_base_a5_a6_compiler_v4.py", 59239,
    "3949c5b98432cabebef989304cb70201266d48b7bdd71a6301a955000a9755c7")
BASE_CHECKER_PIN = (
    "crosscheck/check_d972_r07_zero_base_a5_a6_compiler_v4.py", 45942,
    "cc88aeed18c4f14481971595ab22070720f68ce3fbe48f1057ecd89b610178aa")
BASE_DRIVER_PIN = (
    "search/d972_r07_zero_base_a5_a6_compiler_gha_driver_v4.g", 4255,
    "2349f5a84afadcd90e26aad9bb98689c8df099e733951cc3cd8fd7425a2cbef0")
TASK292_PIN = (
...
def static_bindings() -> dict[str, Any]:
    return {
        ...
        "a5_v4_producer": pin_value(BASE_PIN),
        "a5_v4_checker": pin_value(BASE_CHECKER_PIN),
        "a5_v4_driver": pin_value(BASE_DRIVER_PIN),
        ...
        "task193_v4_producer": pin_value(TASK193_PRODUCER_PIN),
        "task193_v4_checker": pin_value(TASK193_CHECKER_PIN),
        "task193_v4_driver": pin_value(TASK193_DRIVER_PIN),
    }
...
def check(args: argparse.Namespace) -> dict[str, Any]:
    ...
    v4 = load_pinned(V4_CHECKER_PIN, "r07_fusion_v4_checker_for_v6")
    base = load_pinned(BASE_CHECKER_PIN, "r07_a5_v4_checker_for_fusion_v6")
    task193, task193_id = base.load_task193(args.task193_receipt,
                                             args.task193_verdict)
    task292 = load_pinned(TASK292_CHECKER_PIN,
                          "r07_task292_v2_checker_for_fusion_v6")
    ...
    require(receipt.get("owners", {}).get("task193_v4") == task193_id,
    ...
    bindings = {
        ...
        "task193_v4": receipt["owners"]["task193_v4"],
        "a5_v4_in_process": {"source": pin_value(BASE_PIN),
    ...
    return seal({
        ...
        "receipt": receipt_id, "task193_v4": task193_id,
