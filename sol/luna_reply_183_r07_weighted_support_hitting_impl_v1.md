...
Producer/checker identities are unchanged by this driver-only repair.
...
The driver-only GAP stream repair supersedes the driver row immediately
above. The authoritative next-run quartet is:
