...
## GHA transport and cross-check evidence

Transport-only run `32326509922` was skipped before mathematics because its preamble/package was malformed.  The successful cross-checked run was `32326652060`, commit [`c35f108dc0f7438a98d9b6cf704a5b78efa177d4`](https://github.com/tochiazuma0510-alt/shadow-atelier/commit/c35f108dc0f7438a98d9b6cf704a5b78efa177d4), [run URL](https://github.com/tochiazuma0510-alt/shadow-atelier/actions/runs/32326652060).  Artifact `id=9391962114`, name `gap-run-out`, size `131164`; [artifact URL](https://github.com/tochiazuma0510-alt/shadow-atelier/actions/runs/32326652060/artifacts/9391962114).  Receipt SHA256 is `d556a3e579390ae09ea005d1de94b0d2f88b5ed5f9c5d230034b316afe45fc8d` (1043815 bytes), with checker PASS.  Job time was 1135 s, run step 1077 s, producer 530.736960599 s, peak RSS 744943616 bytes.

Cross-checked finite result: targets 1--5 have rank 0; target 6 has 33687 equations, rank 54, nullity 54, and is inconsistent.  The old104 comparison has the same digest `e99602b0981251e4bb81ab0d2113791563bc9ec9df2a45828aea2880ec6d2f9e` and rank 50, so the appended four columns contribute independent quotient rank +4.  The dual has support 1 at component 4 / `q*`, with `y^T b=1` and `y^T z=2`, annihilating all 108 columns.  This remains scoped to `unknown_not_obstruction` against the fixed prefix; it is not a negative/nonexistence claim.

B345_SEEDSPAN_TRIPLE4_V1_CROSSCHECKED
