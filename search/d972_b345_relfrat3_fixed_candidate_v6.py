#!/usr/bin/env python3
"""Cap-calibrated fixed-candidate sparse-DAG lane at relative Frattini-3.
...
class ResourceMonitor:
    ...
    def _progress(self, force: bool = False) -> None:
        ...
        print("D972_B345_RELFRAT3_FIXED_CANDIDATE_CAP_V6_PROGRESS "
...
def run(q3_path: Path, output_path: Path) -> dict[str, Any]:
    ...
    def record_phase(label: str) -> None:
        ...
        print(f"D972_B345_RELFRAT3_FIXED_CAP_V6_PHASE {label} "
    ...
    source_hashes = {
        "producer_sha256": digest_file(Path(__file__)),
        "checker_sha256": digest_file(repo/"search/check_d972_b345_relfrat3_fixed_candidate_v6.py"),
        "driver_sha256": digest_file(repo/"search/d972_b345_relfrat3_fixed_candidate_gha_driver_v6.g"),
    }
    receipt = make_base_receipt(q3_path, output_path, q3_data, source_hashes,
                                "B345_RELFRAT3_FIXED_CANDIDATE_UNKNOWN_RESOURCE",
...
def self_test_fixed() -> None:
    ...
    print("D972_B345_RELFRAT3_FIXED_CANDIDATE_CAP_V6_PRODUCER_SELFTEST_PASS "
          ...
          "cap_delta=2 stride_injective=1 cache_neutral=1 old_cap_continue=1")
...
if __name__ == "__main__":
    try:
        ...
        print(f"B345_RELFRAT3_FIXED_CANDIDATE_CAP_V6_PRODUCER_FAIL {exc}", file=sys.stderr)
        raise SystemExit(1)
