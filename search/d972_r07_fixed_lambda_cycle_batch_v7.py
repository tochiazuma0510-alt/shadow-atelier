...
C_FILE = "check_d972_r07_fixed_lambda_cycle_batch_v7.py"
...
WORKFLOW = ".github/workflows/d972-r07-fixed-lambda-cycle-batch-v7.yml"
...
def final_manifest_value(binding: Any, state: Any, selection: Any, terminal: str, kind: str,
    ...
    return seal("final-manifest", {**{key: binding[key] for key in
        ...
        "anchor_previous_parent_batch_rows": 256, "anchor_total_parent_batch_rows": 384, "selected_count": selection["selected_count"],
