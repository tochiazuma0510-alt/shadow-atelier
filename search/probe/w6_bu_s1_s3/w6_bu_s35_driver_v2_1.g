#############################################################################
## search/probe/w6_bu_s1_s3/w6_bu_s35_driver_v2_1.g
...
F35_PASS := f351 and f352;;   ## v2.1 item (3): real, not hardcoded
...
selfSha := ComputeSha256File("search/probe/w6_bu_s1_s3/w6_bu_s35_driver_v2_1.g");;

report := Concatenation(
"{\n",
"\"schema\":\"w6-bu-s35-v2.1-cert/v1\",\n",
"\"note\":\"NOT the frozen w6-bu-firing-cert/v1 schema. v2.1: falsifier-review repair of the v2 companion report (裁定615), laid ALONGSIDE v2 (v2 driver/certs UNCHANGED). Implements Sol F110-2.5 reclaim bundle 1-2 (裁定594) plus the six 裁定615 repair items -- see driver header for the full list.\",\n",
"\"design_doc\":\"docs/notes/bu_s35_embedding_v1.md\",\n",
"\"authorization\":\"裁定594 (司令塔), implementing sol/sol_reply_110_math36.md F110-2.5 minimal reclaim bundle items 1-2; 裁定615 (falsifier judgment), 6-item repair, this file\",\n",
"\"driver_self_sha256\":", JStr(selfSha), ",\n",
"\"driver_self_sha256_note\":\"sha256 of THIS driver script (w6_bu_s35_driver_v2_1.g) -- identical across all shards run from the same driver file (renamed from v2's ambiguous 'self_sha256' -- v2.1 item 6/naming; do not confuse with the per-SHARD-OUTPUT hash, which merge_s35_v2_1_shards.py computes separately and correctly as shard_provenance[].shard_output_sha256)\",\n",
"\"counts_v2\":{\n",
...
OUT_PATH := Concatenation("search/certs/w6_bu_s35_v2_1_20260806", V2_OUT_SUFFIX, ".json");;
