#!/usr/bin/env python3
"""Task991: v2 strict original-start count admission for the Task982 readout.
...
def admit_parents(args: argparse.Namespace) -> Parents:
    ...
    wanted_sources = {"producer": "search/d972_r07_continuation_positive_word_readout_v2.py",
...
def selftest() -> Any:
    ...
    with tempfile.TemporaryDirectory(prefix="r07-positive-word-selftest-") as temporary:
        ...
        tests = [selftest_word(root / "word"), selftest_history(root / "history"), selftest_raw(root / "raw"),
                 selftest_original_start_header()]
    require(len(tests) == 4 and all(test["status"] == "PASS" and test["rejected_cases"] for test in tests),
            "four_new_interface_groups")
    return seal("selftest", {"status": "PASS", "tests": tests,
        ...
        "production_interfaces_used": ["WordDAG", "read_normalized_pair", "TargetHistory.add_row",
            ...
            "validate_original_start_header"],
