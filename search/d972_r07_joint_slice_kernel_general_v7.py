...
PASS="R07_JOINT_SLICE_KERNEL_GENERAL_V7_PRODUCER_SELFTEST_PASS"
...
def main(argv=None):
    ...
    a.output.write_bytes(canon(value)+b"\n");print(PASS if a.mode=="SELFTEST" else "R07_JOINT_SLICE_KERNEL_GENERAL_V7_PRODUCER_TERMINAL "+value["terminal"])
