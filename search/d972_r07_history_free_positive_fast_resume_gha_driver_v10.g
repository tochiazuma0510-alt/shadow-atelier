#############################################################################
## Task351 R07 A0/v10 audited fast resume driver.
## ASCII only.  The driver has no recursive self pin.
#############################################################################
D342Producer:="search/d972_r07_history_free_positive_fast_resume_v10.py";;
D342Checker:="crosscheck/check_d972_r07_history_free_positive_fast_resume_v10.py";;
...
D342Raw:="ci/resume/d972_r07_history_free_positive_fast_resume_v10.raw.json";;
D342SelftestReceipt:="ci/in/d972_r07_history_free_positive_fast_resume_selftest_v10.accepted.json";;
D342Base:="ci/out/d972_r07_history_free_positive_fast_resume_v10_production";;
...
D342Selftest:="R07_HISTORY_FREE_POSITIVE_FAST_RESUME_V10_SELFTEST_PASS";;
...
D342Sentinel:="R07_HISTORY_FREE_POSITIVE_FAST_RESUME_V10_DRIVER_PASS";;

D342Pins:=[
 [D342Producer,147892,"235a798e097a7388603a72462a4fef28d9a7e044c47e4339eb4e30714bd9e472"],
 [D342Checker,131175,"b2723e9d6703f3cf529ffab7c571ce5dce8b23a428eb54810f57b05aba4a5b0f"],
...
for D342Name in D342Contents do
  if PositionSublist(D342Name,
      "d972_r07_history_free_positive_fast_resume_v10_")=1 then
...
PrintTo(D342Stream,"mode=\${D972_V10_MODE:-PRODUCTION}\n");
PrintTo(D342Stream,"selftest_receipt=\${D972_V10_SELFTEST_RECEIPT:-",D342SelftestReceipt,"}\n");
PrintTo(D342Stream,"resume=\${D972_V10_RESUME:-}\n");
PrintTo(D342Stream,"resume_manifest=\${D972_V10_RESUME_MANIFEST:-}\n");
