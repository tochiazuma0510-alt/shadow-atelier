#############################################################################
## Thin fail-closed same-job driver for the 157ei lex-first target-6 lane.
#############################################################################

D972EIProducer := "search/d972_b345_lexfirst_block_target6_v1.py";;
D972EIProducerSHA :=
  "f901cffd73069e78c9cc256e1a6c18c7e7ce6adef6d4de0c4fe68970571476bb";;
D972EIChecker := "search/check_d972_b345_lexfirst_block_target6_v1.py";;
D972EICheckerSHA :=
  "d0601533131008002d09a6320ab643df865a2a86245ed23f399e4c469bd93c57";;
D972EITask := "sol/luna_task_157ei_b345_lexfirst_block_target6.md";;
D972EITaskSHA :=
...
D972EIArtifact := "ci/out/d972_b345_lexfirst_block_target6_v1.json";;
D972EISelfLog := "ci/out/d972_b345_lexfirst_block_target6_v1_selftest.log";;
D972EISelfOk := "ci/out/d972_b345_lexfirst_block_target6_v1_selftest.ok";;
D972EIProducerLog := "ci/out/d972_b345_lexfirst_block_target6_v1_producer.log";;
D972EICheckerLog := "ci/out/d972_b345_lexfirst_block_target6_v1_checker.log";;
D972EIMathOk := "ci/out/d972_b345_lexfirst_block_target6_v1_math.ok";;
D972EITiming := "ci/out/d972_b345_lexfirst_block_target6_v1_timing.txt";;
D972EIQ3Child := "ci/out/d972_b345_lexfirst_block_target6_v1_q3_child.g";;
D972EIQ3Log := "ci/out/d972_b345_lexfirst_block_target6_v1_q3_child.log";;
D972EIQ3Ok := "ci/out/d972_b345_lexfirst_block_target6_v1_q3_child.ok";;
...
D972EISelf:=IsBound(D972_B345_LEXBLOCK_TARGET6_V1_SELFTEST) and
  D972_B345_LEXBLOCK_TARGET6_V1_SELFTEST=true;;
D972EIRun:=IsBound(D972_B345_LEXBLOCK_TARGET6_V1_RUN) and
  D972_B345_LEXBLOCK_TARGET6_V1_RUN=true;;
if D972EISelf=D972EIRun then
  Error("157ei driver: select exactly one boolean mode");
fi;
if IsBound(D972_B345_LEXBLOCK_TARGET6_V1_OUTPUT) and
   D972_B345_LEXBLOCK_TARGET6_V1_OUTPUT<>D972EIArtifact then
  Error("157ei driver: optional output differs from fixed artifact");
fi;

if D972EISelf then
  Exec("mkdir -p 'ci/out' && rm -f 'ci/out/d972_b345_lexfirst_block_target6_v1_selftest.log' 'ci/out/d972_b345_lexfirst_block_target6_v1_selftest.ok' && python3 -u -B search/d972_b345_lexfirst_block_target6_v1.py --self-test > 'ci/out/d972_b345_lexfirst_block_target6_v1_selftest.log' 2>&1 && python3 -u -B search/check_d972_b345_lexfirst_block_target6_v1.py --self-test >> 'ci/out/d972_b345_lexfirst_block_target6_v1_selftest.log' 2>&1 && printf '%s' 'D972_B345_LEXBLOCK_TARGET6_V1_SELFTEST_EXIT_ZERO' > 'ci/out/d972_b345_lexfirst_block_target6_v1_selftest.ok'");;
  if D972EIRead(D972EISelfOk,"selftest sentinel")<>
       "D972_B345_LEXBLOCK_TARGET6_V1_SELFTEST_EXIT_ZERO" then
    Error("157ei driver: selftest sentinel");
  fi;
  D972EISelfRaw:=D972EIRead(D972EISelfLog,"selftest log");;
  if D972EICount(D972EISelfRaw,
       "D972_B345_LEXBLOCK_TARGET6_PRODUCER_SELFTEST_PASS")<>1 or
     D972EICount(D972EISelfRaw,
       "D972_B345_LEXBLOCK_TARGET6_CHECKER_SELFTEST_PASS")<>1 or
     D972EICount(D972EISelfRaw,
  ...
  Print(D972EISelfRaw,
    "\nB345_LEXBLOCK_TARGET6_V1_GHA_DRIVER_PASS mode=selftest\n");;
else
  Exec("mkdir -p 'ci/out' && rm -f 'ci/out/d972_b345_q3_chief_v1.json' 'ci/out/d972_b345_q3_checker_full.log' 'ci/out/d972_b345_q3_checker_full.ok' 'ci/out/d972_b345_lexfirst_block_target6_v1_q3_child.g' 'ci/out/d972_b345_lexfirst_block_target6_v1_q3_child.log' 'ci/out/d972_b345_lexfirst_block_target6_v1_q3_child.ok' 'ci/out/d972_b345_lexfirst_block_target6_v1.json' 'ci/out/d972_b345_lexfirst_block_target6_v1_producer.log' 'ci/out/d972_b345_lexfirst_block_target6_v1_checker.log' 'ci/out/d972_b345_lexfirst_block_target6_v1_math.ok' 'ci/out/d972_b345_lexfirst_block_target6_v1_timing.txt'");;
  ...
  Exec("bash -o pipefail -c 'gap -l \";/usr/share/gap;/usr/lib/gap;${GAP_P2_PACKAGE_ROOT:?}\" --quitonbreak -q -o 12g ci/out/d972_b345_lexfirst_block_target6_v1_q3_child.g 2>&1 | tee ci/out/d972_b345_lexfirst_block_target6_v1_q3_child.log' && printf '%s' 'D972_B345_LEXBLOCK_TARGET6_V1_Q3_EXIT_ZERO' > 'ci/out/d972_b345_lexfirst_block_target6_v1_q3_child.ok'");;
  if D972EIRead(D972EIQ3Ok,"q3 sentinel")<>
       "D972_B345_LEXBLOCK_TARGET6_V1_Q3_EXIT_ZERO" then
  ...
  Exec("bash -o pipefail -c 'set -e; SECONDS=0; python3 -u -B search/d972_b345_lexfirst_block_target6_v1.py --q3 ci/out/d972_b345_q3_chief_v1.json --output ci/out/d972_b345_lexfirst_block_target6_v1.json --seconds 18000 2>&1 | tee ci/out/d972_b345_lexfirst_block_target6_v1_producer.log; producer_elapsed=$SECONDS; remaining=$((18000-SECONDS)); if [ $remaining -le 0 ]; then exit 97; fi; python3 -u -B search/check_d972_b345_lexfirst_block_target6_v1.py --q3 ci/out/d972_b345_q3_chief_v1.json --receipt ci/out/d972_b345_lexfirst_block_target6_v1.json --seconds $remaining 2>&1 | tee ci/out/d972_b345_lexfirst_block_target6_v1_checker.log; final_elapsed=$SECONDS; final_remaining=$((18000-final_elapsed)); if [ $final_remaining -le 0 ]; then exit 98; fi; printf \"producer_elapsed=%s\\nchecker_initial_remaining=%s\\nfinal_elapsed=%s\\nfinal_margin=%s\\n\" $producer_elapsed $remaining $final_elapsed $final_remaining > ci/out/d972_b345_lexfirst_block_target6_v1_timing.txt; printf %s D972_B345_LEXBLOCK_TARGET6_V1_MATH_EXIT_ZERO > ci/out/d972_b345_lexfirst_block_target6_v1_math.ok'");;
  if D972EIRead(D972EIMathOk,"math sentinel")<>
       "D972_B345_LEXBLOCK_TARGET6_V1_MATH_EXIT_ZERO" then
  ...
  if D972EITerminalCount<>1 or
     D972EICount(D972EIProducerRaw,
       "D972_B345_LEXBLOCK_TARGET6_PRODUCER_PASS")<>1 then
    Error("157ei driver: producer terminal/exit markers");
  fi;
  D972EICheckerRaw:=D972EIRead(D972EICheckerLog,"checker log");;
  if D972EICount(D972EICheckerRaw,
       "D972_B345_LEXBLOCK_TARGET6_CHECKER_PASS")<>1 then
  ...
  Print("B345_LEXBLOCK_TARGET6_V1_GHA_DRIVER_PASS mode=full artifact_sha256=",
