...
D379Producer:="search/d972_r07_actual_a0_class_two_q2_v2.py";;
D379Checker:="crosscheck/check_d972_r07_actual_a0_class_two_q2_v2.py";;
D379ProducerBytes:=50355;;
D379ProducerSHA:="125eb99d54764c546511741ac8eaefaa07c1fdaf2026117ee99fbfa4e6010627";;
D379CheckerBytes:=51554;;
D379CheckerSHA:="5388d7a6dd91c61011299b9e545d1f77ae5b1e53d7ccbc195f0b698c10638261";;
D379Receipt:="ci/out/d972_r07_actual_a0_class_two_q2_v2.json";;
D379Verdict:="ci/out/d972_r07_actual_a0_class_two_q2_v2.checker.json";;
D379Checkpoint:="ci/out/d972_r07_actual_a0_class_two_q2_v2.checkpoint.json";;
D379ProducerLog:="ci/out/d972_r07_actual_a0_class_two_q2_v2.producer.log";;
D379CheckerLog:="ci/out/d972_r07_actual_a0_class_two_q2_v2.checker.log";;
D379Script:="ci/out/d972_r07_actual_a0_class_two_q2_v2.sh";;
D379OK:="ci/out/d972_r07_actual_a0_class_two_q2_v2.ok";;
...
PrintTo(D379S,"p=$(sed -n 's/^R07_ACTUAL_A0_CLASS_TWO_Q2_V2_PRODUCER_TERMINAL //p' ",
  D379ProducerLog,")\n");;
PrintTo(D379S,"case \"$p\" in R07_ACTUAL_A0_CLASS_TWO_Q2_V2_COMPLETE|UNKNOWN_INPUT|UNKNOWN_RESOURCE) ;; *) exit 1;; esac\n");;
PrintTo(D379S,"test -s ",D379Receipt," && test -s ",D379Checkpoint,"\n");;
PrintTo(D379S,"final=\"$p\"\n");;
PrintTo(D379S,"if test \"$p\" = R07_ACTUAL_A0_CLASS_TWO_Q2_V2_COMPLETE; then\n");;
...
PrintTo(D379S,"  c=$(sed -n 's/^R07_ACTUAL_A0_CLASS_TWO_Q2_V2_CHECKER terminal=//p' ",
  D379CheckerLog,")\n");;
PrintTo(D379S,"  case \"$c\" in\n");;
PrintTo(D379S,"    R07_ACTUAL_A0_CLASS_TWO_Q2_V2_COMPLETE) grep -Fq '\"status\":\"ACCEPTED\"' ",D379Verdict," ;;\n");;
...
PrintTo(D379S,"fi\n");;
PrintTo(D379S,"printf '%s\\n' \"R07_ACTUAL_A0_CLASS_TWO_Q2_V2_DRIVER_COMPLETE terminal=$final\" > ",D379OK,"\n");;
CloseStream(D379S);;
Exec(Concatenation("bash ",D379Script));;
if not IsExistingFile(D379OK) then Error("task379 missing success marker"); fi;
Print("R07_ACTUAL_A0_CLASS_TWO_Q2_V2_DRIVER_COMPLETE\n");;
