#############################################################################
## Task350 R07 A0/v9 audited fast resume driver.
## ASCII only.  The driver has no recursive self pin.
#############################################################################
D342Producer:="search/d972_r07_history_free_positive_fast_resume_v9.py";;
D342Checker:="crosscheck/check_d972_r07_history_free_positive_fast_resume_v9.py";;
D342Fixture:="search/certs/d972_r07_history_free_positive_fast_resume_selftest_v9_20260829.json";;
...
D342Raw:="ci/resume/d972_r07_history_free_positive_fast_resume_v9.raw.json";;
D342SelftestReceipt:="ci/in/d972_r07_history_free_positive_fast_resume_selftest_v9.accepted.json";;
D342Base:="ci/out/d972_r07_history_free_positive_fast_resume_v9_production";;
...
D342Common:="R07_HISTORY_FREE_POSITIVE_FAST_RESUME_V9_COMMON_WORD";;
D342Selftest:="R07_HISTORY_FREE_POSITIVE_FAST_RESUME_V9_SELFTEST_PASS";;
D342ProducerPrefix:="R07_HISTORY_FREE_POSITIVE_FAST_RESUME_V9_PRODUCER_TERMINAL";;
D342CheckerPrefix:="R07_HISTORY_FREE_POSITIVE_FAST_RESUME_V9_CHECKER_TERMINAL";;
D342Sentinel:="R07_HISTORY_FREE_POSITIVE_FAST_RESUME_V9_DRIVER_PASS";;

D342Pins:=[
 [D342Producer,144091,"7dd977b009dc3b3b2946efe569d5eb78eaf46490f875af7117471d25e69e5199"],
 [D342Checker,116223,"562b1fd377c436e212199e23edf987aa418bcdb47262344c71e26c375ef05ae1"],
 [D342Fixture,3336,"c60ba21b577ad3f4475896033078a24028e26fcfed796989a10c0d666003ff64"],
...
for D342Name in D342Contents do
  if PositionSublist(D342Name,
      "d972_r07_history_free_positive_fast_resume_v9_")=1 then
...
PrintTo(D342Stream,"mode=\${D972_V9_MODE:-PRODUCTION}\n");
PrintTo(D342Stream,"selftest_receipt=\${D972_V9_SELFTEST_RECEIPT:-",D342SelftestReceipt,"}\n");
PrintTo(D342Stream,"resume=\${D972_V9_RESUME:-}\n");
PrintTo(D342Stream,"resume_manifest=\${D972_V9_RESUME_MANIFEST:-}\n");
