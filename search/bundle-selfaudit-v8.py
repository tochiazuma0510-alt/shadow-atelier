#!/usr/bin/env python3
# bundle-selfaudit-v8.py -- N_infty stage2 freeze bundle self-audit (15 checks + M70/M71/M72/M74 変異試験)
# usage: python search/bundle-selfaudit-v8.py [--mutate]   (exit 0 = ALL PASS)
...
F = {"spec":     "docs/week4-NInfty_stage2_spec_v18.md",
     "contract": "docs/mb_ninfty_verifier_contract_v13.md",
     "manifest": "docs/mb_dependency_manifest_v13.md"}
CUR = {"spec": "v18", "contract": "v13", "manifest": "v13"}
