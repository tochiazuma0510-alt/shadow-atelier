#!/usr/bin/env python3
"""Independent checker for the 157bd D972 core intersection certificate.
...
G9^4, and replays every lossless source word in the receipt.  It does not
import the GAP producer or assume that the G9^4 projection is onto.
"""
...
PRODUCER_PATH = ROOT / "search/d972_d972core_c2six_intersection_v1.g"
PRODUCER_SHA = "52005b33e3357afa85a5f0400eb9f9589ab052d0f18f0844a7e514bb16438aae"
DEGREE_E = 72
DEGREE_P = 9
DEGREE_G9 = 27
...
def validate_report(report: dict, core: dict, maps: dict) -> None:
    if report.get("schema") != "d972-d972core-c2six-intersection/v1":
        raise AssertionError("schema drift")
    if report.get("final_marker") != "D972_CORE_INTERSECTION_FINAL":
        raise AssertionError("final marker drift")
    if report.get("status") != "CORE_INTERSECTION_COMPUTED":
...
def static_selftest() -> None:
    ...
    print("D972_CORE_INTERSECTION_CHECKER_SELFTEST_PASS")
...
def main() -> int:
    ...
    print("D972_CORE_INTERSECTION_CHECK_PASS", args.receipt)
    return 0
