#!/usr/bin/env python3
"""R07 pre-A0 single-target A3/v6 producer.
            ...
            class PackedJointGroup(joint.JointGroup):
                def blob(self, value):
                    return p176.packed_joint_blob(
                        value, "v6 task198 evaluator Gamma element")
...
def load_engine(rel, size, sha, tag_name, meter):
    ...
    module_name = "_pre_a0_a3_v6_producer_" + tag_name
...
def main(argv=None):
    ...
    parser.add_argument("--output",
                        default="ci/out/d972_r07_pre_a0_single_target_a3_v6.json")
    args = parser.parse_args(argv)
    meter = Meter()
    try:
        install_linux_hard_limits(meter)
        with WallDeadline(meter, "complete v6 producer route"):
    ...
    try:
        ...
        with WallDeadline(meter, "complete v6 producer emergency publication"):
            target = prepare_output(args.output)
        ...
        print("D363_PRODUCER_UNKNOWN_REASON " +
