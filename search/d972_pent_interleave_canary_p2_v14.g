#############################################################################
## D972 p=2 literal-A.18 identity-serialization repair v14 generator.
##
## Authenticates frozen outer v11, mechanically generates a hash-pinned v14
...
P159P2G12OverlayPath :=
  "search/d972_pent_interleave_literal_a18_p2_overlay_v14.g";
P159P2G12OverlayBytes := 11655;
P159P2G12OverlaySha :=
  "f06fd415816deeaac12ae70d98b0125f58a39ab78dbced578c97b0b9102ae1d8";
P159P2G12GeneratedOuterPath :=
  "ci/out/d972_pent_interleave_canary_p2_outer_effective_v14.g";
P159P2G12GeneratedOuterBytes := 19822;
P159P2G12GeneratedOuterSha :=
  "61d36d5d47ea44ab6cc43c532a65273fc387a66c74b5baecb7c71b97af43b86d";

P159P2G12Count := function(s,needle)
  local count,pos,tail,offset,rel;
  if Length(needle)=0 then Error("PENT159N_P2_V14_GENERATOR: empty needle"); fi;
...
P159P2G12Replace := function(s,old,new,expected,label)
  ...
  if got<>expected then
    Error("PENT159N_P2_V14_GENERATOR: replacement count drift ",label,
...
P159P2G12Write := function(path,payload)
  ...
  if stream=fail then Error("PENT159N_P2_V14_GENERATOR: cannot open generated outer"); fi;
  ...
  if readback=fail or readback<>payload or
    ...
    Error("PENT159N_P2_V14_GENERATOR: generated outer closed-write mismatch");
  fi;
...
if P159P2G12Raw=fail or Length(P159P2G12Raw)<>P159P2G12BaseOuterBytes or
  ...
  Error("PENT159N_P2_V14_GENERATOR: frozen v11 outer pin drift");
fi;
...
if P159P2G12OverlayRaw=fail or
  ...
  Error("PENT159N_P2_V14_GENERATOR: v12 finite-gate overlay pin drift");
fi;
...
P159P2G12Out:=P159P2G12Replace(P159P2G12Out,
  "PENT159N_P2_OUTER_V11","PENT159N_P2_OUTER_V14",16,
  "outer diagnostic namespace");
P159P2G12Out:=P159P2G12Replace(P159P2G12Out,
  "PENT159N_P2_V11","PENT159N_P2_V14",13,
  "math diagnostic strings");
P159P2G12Out:=P159P2G12Replace(P159P2G12Out,
  "p=2 literal-A.18 repair v11",
  "p=2 literal-A.18 identity-serialization repair v14",1,"outer header");
P159P2G12Out:=P159P2G12Replace(P159P2G12Out,
  "search/d972_pent_interleave_literal_a18_p2_overlay_v11.g",
  P159P2G12OverlayPath,4,"overlay paths");
P159P2G12Out:=P159P2G12Replace(P159P2G12Out,
  "6048","11655",1,"overlay bytes");
P159P2G12Out:=P159P2G12Replace(P159P2G12Out,
...
P159P2G12Out:=P159P2G12Replace(P159P2G12Out,
  ...
  "ci/out/d972_pent_interleave_canary_p2_math_effective_v14.g",1,
  "math effective path");
P159P2G12Out:=P159P2G12Replace(P159P2G12Out,
  "56314","56724",1,"math effective bytes");
P159P2G12Out:=P159P2G12Replace(P159P2G12Out,
  "6f6f7b1a9adbc54882006865b29b77d8560fefbaa5e015c6d60511dc56a96404",
  "c0085eea895d3ec9282af130ae77f3cbded9082e71e81a9b88fbec11284b5d63",
  1,"math effective SHA");
P159P2G12Out:=P159P2G12Replace(P159P2G12Out,
  "ci/out/d972_pent_interleave_canary_p2_receipt_v11_20260824.json",
  "ci/out/d972_pent_interleave_canary_p2_receipt_v14_20260824.json",1,
  "receipt path");
P159P2G12Out:=P159P2G12Replace(P159P2G12Out,
  "d972-pent-interleave-canary-p2/v11",
  "d972-pent-interleave-canary-p2/v14",2,"schema strings");
P159P2G12Out:=P159P2G12Replace(P159P2G12Out,
  "finite p=2 literal-A.18 repair stage v11",
  "finite p=2 literal-A.18 identity-serialization repair stage v14",1,
  "generated math header");
P159P2G12Out:=P159P2G12Replace(P159P2G12Out,
  "MEASURED_P2_LITERAL_A18_REPAIR_V11",
  "MEASURED_P2_LITERAL_A18_IDENTITY_SERIALIZATION_REPAIR_V14",1,
  "receipt status");
...
P159P2G12NewHeader:=JoinStringsWithSeparator([
  ...
  "  \"## faithful-Artin replay is superseded as a resource trap.  V14 consumes literal page-49 products and checks both\",",
...
P159P2G12Out:=P159P2G12Replace(P159P2G12Out,
  ...
  "literal A.18 p2 v14 identity-serialization overlay",1,"overlay label");
...
P159P2G12OldEarly:=JoinStringsWithSeparator([
  ...
  "  \"  Error(\\\"PENT159N_P2_V14: literal A.18 pre-census gate did not close\\\");\","],"\n");
P159P2G12NewEarly:=JoinStringsWithSeparator([
  "  \"if not IsBoundGlobal(\\\"P159P2V12A18RunFiniteRelatorGate\\\") then\",",
  "  \"  Error(\\\"PENT159N_P2_V14: literal A.18 finite relator-gate function absent\\\");\","],"\n");
P159P2G12Out:=P159P2G12Replace(P159P2G12Out,
...
P159P2G12NewMapStart:=JoinStringsWithSeparator([
  ...
  "  \"  Error(\\\"PENT159N_P2_V14: finite A.18 gate did not close before maps/census\\\");\",",
  "  \"fi;\",",
  "  \"P159P2V12DelWords:=P159P2V12Deletions(4);\","],"\n");
P159P2G12Out:=P159P2G12Replace(P159P2G12Out,
...
P159P2G12Out:=P159P2G12Replace(P159P2G12Out,
  ...
  "p2_v1_through_v13_edited:=false,v14_overwrote_prior_version:=false",1,
  "firewall version boundary");
P159P2G12Out:=P159P2G12Replace(P159P2G12Out,
  "p2_v1_through_v10_edited:=false",
  "p2_v1_through_v13_edited:=false",2,
...
P159P2G12Out:=P159P2G12Replace(P159P2G12Out,
  ...
  1,"A.18 identity serialization receipt");
P159P2G12Out:=P159P2G12Replace(P159P2G12Out,
  "  [[4,2],[6]],","  [[2,4],[6]],",1,
  "literal phi12_3_4 F2 context");
P159P2G12Out:=P159P2G12Replace(P159P2G12Out,
  "  [[2,1],[6,5]],","  [[1,2],[5,6]],",1,
  "literal phi1_23_4 F2 context");
P159P2G12Out:=P159P2G12Replace(P159P2G12Out,
  "  [[1],[5,4]],","  [[1],[4,5]],",1,
  "literal phi1_2_34 F2 context");

if Length(P159P2G12Out)<>P159P2G12GeneratedOuterBytes or
   HexSHA256(P159P2G12Out)<>P159P2G12GeneratedOuterSha then
  Error("PENT159N_P2_V14_GENERATOR: generated outer pin drift bytes=",
    Length(P159P2G12Out)," sha256=",HexSHA256(P159P2G12Out));
fi;
P159P2G12WriteState:=P159P2G12Write(P159P2G12GeneratedOuterPath,
  P159P2G12Out);
Print("PENT159N_P2_V14_OUTER_GENERATED path=",P159P2G12GeneratedOuterPath,
...
if not IsBoundGlobal("P159P2V12Receipt") or
  ...
  Error("PENT159N_P2_V14_GENERATOR: generated outer returned without receipt");
fi;
P159P2G12Receipt:=ValueGlobal("P159P2V12Receipt");
P159P2G12Gate:=P159P2G12Receipt.marked_maps.a18_source_relator_gate;
if P159P2G12Receipt.schema<>"d972-pent-interleave-canary-p2/v14" or
   P159P2G12Gate.literal_all_relators_preserved<>true or
   P159P2G12Gate.required_reversal_mutant_failure.passed<>false then
  Error("PENT159N_P2_V14_GENERATOR: final finite-gate receipt check failed");
fi;
Print("PENT159N_P2_V14_GENERATOR_FINAL_PASS receipt_schema=",
