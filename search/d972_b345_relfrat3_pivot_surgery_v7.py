#!/usr/bin/env python3
"""Pivot-directed fixed-candidate sparse-DAG lane at relative Frattini-3.
...
SCHEMA = "d972-b345-relative-frattini3-pivot-surgery/v7"
...
OUTPUT_PATH = Path("ci/out/d972_b345_relfrat3_pivot_surgery_v7.json")
...
class ResourceMonitor:
    ...
    def _progress(self, force: bool = False) -> None:
        ...
        print("D972_B345_RELFRAT3_PIVOT_SURGERY_V7_PROGRESS "
    ...
    def receipt(self, hit: bool) -> dict[str, Any]:
        return {
            ...
            "terminal_on_hit": "B345_RELFRAT3_PIVOT_SURGERY_UNKNOWN_RESOURCE",
...
def run(q3_path: Path, output_path: Path) -> dict[str, Any]:
    ...
    def record_phase(label: str) -> None:
        ...
        print(f"D972_B345_RELFRAT3_PIVOT_SURGERY_V7_PHASE {label} "
    ...
    source_hashes = {
        "producer_sha256": digest_file(Path(__file__)),
        "checker_sha256": digest_file(repo/"search/check_d972_b345_relfrat3_pivot_surgery_v7.py"),
        "driver_sha256": digest_file(repo/"search/d972_b345_relfrat3_pivot_surgery_gha_driver_v7.g"),
    }
    receipt = make_base_receipt(q3_path, output_path, q3_data, source_hashes,
                                "B345_RELFRAT3_PIVOT_SURGERY_UNKNOWN_RESOURCE",
    ...
    try:
        ...
        receipt["directed_surgery"] = {
            ...
            "translations_sha256": digest_obj(public_directed_translations),
...
if __name__ == "__main__":
    try:
        ...
        print(f"B345_RELFRAT3_PIVOT_SURGERY_V7_PRODUCER_FAIL {exc}", file=sys.stderr)
        raise SystemExit(1)
