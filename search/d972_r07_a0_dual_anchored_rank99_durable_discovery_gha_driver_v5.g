#############################################################################
## R07 durable discovery v5 driver. ASCII only.
#############################################################################
if not IsBound(D972_R07_A0_DUAL_ANCHORED_RANK99_DURABLE_DISCOVERY_V5_RUN) or
   D972_R07_A0_DUAL_ANCHORED_RANK99_DURABLE_DISCOVERY_V5_RUN<>true then
 Error("task490 external run preamble required"); fi;
if not IsBound(D972_R07_A0_DUAL_ANCHORED_RANK99_DURABLE_DISCOVERY_V5_INPUT) then
 D972_R07_A0_DUAL_ANCHORED_RANK99_DURABLE_DISCOVERY_V5_INPUT:=
  "search/certs/d972_r07_a0_dual_anchored_rank99_candidate_v1.json";; fi;
D482Input:=D972_R07_A0_DUAL_ANCHORED_RANK99_DURABLE_DISCOVERY_V5_INPUT;;
D482Producer:="search/d972_r07_a0_dual_anchored_rank99_durable_discovery_v5.py";;
D482Checker:="crosscheck/check_d972_r07_a0_dual_anchored_rank99_durable_discovery_v5.py";;
...
D482ProducerBytes:=104031;; D482ProducerSHA:="25c308ec11b9f36cc9779dfec46058a4956068969d664ee582a26f9cb0db7c09";;
D482CheckerBytes:=71589;; D482CheckerSHA:="970ffe3a78687f3a27a222e089ae3d5e928bbfa048b9aef9f51fcf4c0b5d578d";;
...
D482Receipt:="ci/out/d972_r07_a0_dual_anchored_rank99_durable_discovery_v5.json";;
D482Checkpoint:="ci/out/d972_r07_a0_dual_anchored_rank99_durable_discovery_v5.checkpoint";;
D482Verdict:="ci/out/d972_r07_a0_dual_anchored_rank99_durable_discovery_v5.checker.json";;
D482PLog:="ci/out/d972_r07_a0_dual_anchored_rank99_durable_discovery_v5.producer.log";;
D482CLog:="ci/out/d972_r07_a0_dual_anchored_rank99_durable_discovery_v5.checker.log";;
D482Script:="ci/out/d972_r07_a0_dual_anchored_rank99_durable_discovery_v5.sh";;
D482OK:="ci/out/d972_r07_a0_dual_anchored_rank99_durable_discovery_v5.ok";;
...
PrintTo(D482S,"test \"$(grep -Ec '^R07_A0_DUAL_ANCHORED_RANK99_DURABLE_DISCOVERY_V5 status=(COMMON_CANDIDATE|UNKNOWN_RESOURCE)$' ",D482PLog,")\" = 1\n");;
PrintTo(D482S,"if grep -Eq '^R07_A0_DUAL_ANCHORED_RANK99_DURABLE_DISCOVERY_V5 status=UNKNOWN_RESOURCE$' ",D482PLog,"; then\n");;
PrintTo(D482S," test -s ",D482Receipt," && test -s ",D482Checkpoint,"\n");;
PrintTo(D482S," grep -Eq '\"candidate_marker\":\"R07_A0_DUAL_ANCHORED_RANK99_DURABLE_DISCOVERY_V5_RESOURCE_CANDIDATE\"' ",D482Receipt,"\n");;
...
PrintTo(D482S," printf '%s\\n' 'R07_A0_DUAL_ANCHORED_RANK99_DURABLE_DISCOVERY_V5_RESOURCE_CANDIDATE' > ",D482OK,"\n");;
PrintTo(D482S," test \"$(wc -l < ",D482OK," | tr -d '[:space:]')\" = \"1\"\n");;
PrintTo(D482S," test \"$(cat ",D482OK,")\" = \"R07_A0_DUAL_ANCHORED_RANK99_DURABLE_DISCOVERY_V5_RESOURCE_CANDIDATE\"\n");;
PrintTo(D482S," test \"$(grep -Ec 'R07_A0_DUAL_ANCHORED_RANK99_DURABLE_DISCOVERY_V5_COMPLETE' ",D482OK,")\" = \"0\"\n");;
PrintTo(D482S," exit 0\nfi\n");;
PrintTo(D482S,"test \"$(grep -Ec '^R07_A0_DUAL_ANCHORED_RANK99_DURABLE_DISCOVERY_V5 status=COMMON_CANDIDATE$' ",D482PLog,")\" = 1\n");;
...
PrintTo(D482S,"test \"$(grep -Ec '^R07_A0_DUAL_ANCHORED_RANK99_DURABLE_DISCOVERY_V5_CHECKER_PASS terminal=COMMON_CANDIDATE$' ",D482CLog,")\" = 1\n");;
PrintTo(D482S,"test -s ",D482Verdict,"\n");;
PrintTo(D482S,"printf '%s\\n' 'R07_A0_DUAL_ANCHORED_RANK99_DURABLE_DISCOVERY_V5_COMPLETE' > ",D482OK,"\n");;
PrintTo(D482S,"test \"$(wc -l < ",D482OK," | tr -d '[:space:]')\" = \"1\"\n");;
PrintTo(D482S,"test \"$(cat ",D482OK,")\" = \"R07_A0_DUAL_ANCHORED_RANK99_DURABLE_DISCOVERY_V5_COMPLETE\"\n");;
...
if D482OKRaw="R07_A0_DUAL_ANCHORED_RANK99_DURABLE_DISCOVERY_V5_RESOURCE_CANDIDATE\n" then
 Print("R07_A0_DUAL_ANCHORED_RANK99_DURABLE_DISCOVERY_V5_RESOURCE_TERMINAL\n");
elif D482OKRaw="R07_A0_DUAL_ANCHORED_RANK99_DURABLE_DISCOVERY_V5_COMPLETE\n" then
 Print("R07_A0_DUAL_ANCHORED_RANK99_DURABLE_DISCOVERY_V5_COMPLETE\n");
