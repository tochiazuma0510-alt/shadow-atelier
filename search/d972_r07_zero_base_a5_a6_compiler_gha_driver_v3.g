#############################################################################
## R07 direct-relator A5/A6 v3 production driver. ASCII only.
#############################################################################
...
D370Producer:="search/d972_r07_zero_base_a5_a6_compiler_v3.py";;
D370Checker:="crosscheck/check_d972_r07_zero_base_a5_a6_compiler_v3.py";;
D370ProducerBytes:=59239;;
D370ProducerSHA:="c287011d5e573452094e62c76020ab4b1076bc427103174b1771a22a1bb4fbd8";;
D370CheckerBytes:=45942;;
D370CheckerSHA:="e86806444efa146954213da4bbb13726a8b5dc79b16c0a4b97aaa5c7b05b1cb0";;
D370Receipt:="ci/out/d972_r07_zero_base_a5_a6_compiler_v3.json";;
D370Verdict:="ci/out/d972_r07_zero_base_a5_a6_compiler_v3.checker.json";;
D370ProducerLog:="ci/out/d972_r07_zero_base_a5_a6_compiler_v3.producer.log";;
D370CheckerLog:="ci/out/d972_r07_zero_base_a5_a6_compiler_v3.checker.log";;
D370Script:="ci/out/d972_r07_zero_base_a5_a6_compiler_v3.sh";;
D370OK:="ci/out/d972_r07_zero_base_a5_a6_compiler_v3.ok";;
...
PrintTo(D370S,"p=$(sed -n 's/^R07_ZERO_BASE_A5_A6_COMPILER_V3_PRODUCER_TERMINAL //p' ",
  D370ProducerLog,")\n");;
...
PrintTo(D370S,"c=$(sed -n 's/^R07_ZERO_BASE_A5_A6_COMPILER_V3_CHECKER terminal=//p' ",
  D370CheckerLog,")\n");;
