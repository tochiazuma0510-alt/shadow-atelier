...
PRODUCER_LINE = "R07_ACTUAL_A0_CLASS_TWO_Q2_V2_PRODUCER_TERMINAL"
BLOCKS = ("H1", "H2", "P")
MODULUS = 3
...
def compile_receipt(args: argparse.Namespace, budget: Budget,
    ...
    owners = {"task193_v4": task193_id, "task198": authority.identity}
...
def parser() -> argparse.ArgumentParser:
    ...
    for key, value in TASK198_DEFAULTS.items():
        ap.add_argument("--task198-" + key, dest="task198_" + key,
                        default=value)
    ap.add_argument("--output", default="ci/out/d972_r07_actual_a0_class_two_q2_v2.json")
    ap.add_argument("--checkpoint", default="ci/out/d972_r07_actual_a0_class_two_q2_v2.checkpoint.json")
