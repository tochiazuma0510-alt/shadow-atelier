...
CURRENT_PRODUCER = Path("search/d972_b345_lexfirst_block_target6_v2.py")
CURRENT_PRODUCER_SHA = \
    "ad9a145f1d432afffc4dd3443dafb7d621708543730150636118d1332d83ce8a"
CURRENT_PRODUCER_BYTES = 148824
...
AUTH_PIN_SPECS = {**PIN_SPECS,
    "157ej_current_producer": (CURRENT_PRODUCER, CURRENT_PRODUCER_SHA,
...
def self_test() -> None:
    ...
    print("D972_B345_LEXBLOCK_TARGET6_V2_CHECKER_SELFTEST_PASS "
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    print("D972_B345_LEXBLOCK_TARGET6_V2_CHECKER_PASS "
