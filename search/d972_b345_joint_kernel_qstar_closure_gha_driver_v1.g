...
D972JKChecker := "search/check_d972_b345_joint_kernel_qstar_closure_v1.py";;
D972JKCheckerSHA := "9e721634d1f16be806e315eec263ec272bc023587f862703c094b7dd37c0111f";;
...
if D972JKSelf then
  Exec("mkdir -p 'ci/out' && rm -f 'ci/out/d972_b345_joint_kernel_qstar_closure_v1_selftest.log' 'ci/out/d972_b345_joint_kernel_qstar_closure_v1_selftest.ok' && python3 -u -B search/d972_b345_joint_kernel_qstar_closure_v1.py --self-test > 'ci/out/d972_b345_joint_kernel_qstar_closure_v1_selftest.log' 2>&1 && python3 -u -B search/check_d972_b345_joint_kernel_qstar_closure_v1.py --self-test >> 'ci/out/d972_b345_joint_kernel_qstar_closure_v1_selftest.log' 2>&1 && printf '%s' 'D972_B345_JOINT_KERNEL_QSTAR_SELFTEST_EXIT_ZERO' > 'ci/out/d972_b345_joint_kernel_qstar_closure_v1_selftest.ok'");;
