...
MARKER = "R07_A0_DUAL_ANCHORED_RANK99_DURABLE_DISCOVERY_V4"
...
def retain_correction_candidate(v4: Any, P: dict[str, Any], m: Any, p179: Any,
    ...
    scalar = v4.b.formula_scalar(model, formula, direct)
...
def fixture() -> dict[str, Any]:
    ...
    fake_formula = {"seed_index": 1, "required_coordinates": [0]}
    ...
    need(len(replay_calls) == 1 and len(replay_calls[0]) == 3 and
         ...
         "fixture:production_replay_v4_abi")
    ...
    return {"status": "PASS", "dependent_replay_reduce_once": True,
            ...
            "production_replay_v4_abi": True, "flush_one": True, "flush_fifteen": True,
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--output", default="ci/out/d972_r07_a0_dual_anchored_rank99_durable_discovery_v4.json")
    parser.add_argument("--checkpoint", default="ci/out/d972_r07_a0_dual_anchored_rank99_durable_discovery_v4.checkpoint")
