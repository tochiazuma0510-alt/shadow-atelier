D363Mode:="gha";;
D363P0:="ci/in/d972_r07_pre_a0_single_target_a3_v3.prereg.v1.json";;
D363Producer:="search/d972_r07_pre_a0_single_target_a3_v3.py";;
D363Checker:="crosscheck/check_d972_r07_pre_a0_single_target_a3_v3.py";;
D363Receipt:="ci/out/d972_r07_pre_a0_single_target_a3_v3.json";;
D363Verdict:="ci/out/d972_r07_pre_a0_single_target_a3_v3.verdict.json";;
D363ProducerLog:="ci/out/d972_r07_pre_a0_single_target_a3_v3.producer.log";;
D363CheckerLog:="ci/out/d972_r07_pre_a0_single_target_a3_v3.checker.log";;
D363Shell:="ci/out/d972_r07_pre_a0_single_target_a3_v3.driver.sh";;
D363Sentinel:="ci/out/d972_r07_pre_a0_single_target_a3_v3.driver.accepted";;
...
D363P0Bytes:=16417;;
D363P0SHA:="2660c8e1dce475d19f4d8a40f43626df401d3ca299f34b0f1dd067db896d2ce6";;
D363P0Self:="0539e586fd6001ff65965e990461f390fc8868bb6fbbd0ec2a9cd4464f91df0e";;
D363Pins:=[
  [D363P0,D363P0SHA,D363P0Bytes],
  [D363Producer,"436e7c06acff9cf2087277a12067371518c2ce033effaf85bff6b04585c0f9cf",95172],
  [D363Checker,"eaaa9d602da22921991f25229eed559c50a920a30c3c56495b0954b40af03485",106148]
];;
...
PrintTo(D363Stream,"compgen -G 'ci/out/.d972_r07_pre_a0_single_target_a3_v3.json.tmp.*' >/dev/null && fail stale-receipt-temp\n");
PrintTo(D363Stream,"compgen -G 'ci/out/.d972_r07_pre_a0_single_target_a3_v3.verdict.json.tmp.*' >/dev/null && fail stale-verdict-temp\n");
...
PrintTo(D363Stream,"need(obj.get('schema')=='d972-r07-pre-a0-single-target-a3/v3/receipt/v1' and obj.get('status')==terminal and obj.get('terminal')==terminal and obj.get('accepted') is True,'receipt terminal')\n");
...
PrintTo(D363Stream,"flags=('actual_a3_numerator','boundary_membership','cofinal_lift','exact_pb_endpoint_zero','fake','Ihara_witness','pointed_mu1','task192_consumed')\n");
PrintTo(D363Stream,"need(verdict.get('schema')=='d972-r07-pre-a0-single-target-a3/v3/verdict/v1' and verdict.get('status')==terminal and verdict.get('terminal')==terminal and verdict.get('accepted') is True and verdict.get('independent') is True and verdict.get('reason') is None,'verdict acceptance')\n");
...
PrintTo(D363Stream,"    try:\n");
PrintTo(D363Stream,"        raw=b'D363_V3_ACCEPTED'; written=os.write(fd,raw)\n");
...
if D363Observed<>"D363_V3_ACCEPTED" then
