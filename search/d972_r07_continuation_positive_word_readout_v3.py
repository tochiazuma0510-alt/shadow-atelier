#!/usr/bin/env python3
"""Task1005: v3 exact saved-refinement HEAD and final-target admission.
...
def admit_parents(args: argparse.Namespace) -> Parents:
    ...
    wanted_sources = {"producer": "search/d972_r07_continuation_positive_word_readout_v3.py",
                      "checker": "search/check_d972_r07_continuation_same_word_eleven_slots_v3.py"}
