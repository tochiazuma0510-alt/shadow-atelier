#!/usr/bin/env python3
"""Task1037: independent fixed-lambda, k128 one-batch cycle checker.
...
PRODUCER_FILE = "search/d972_r07_fixed_lambda_cycle_batch_v3.py"
CHECKER_FILE = "search/check_d972_r07_fixed_lambda_cycle_batch_v3.py"
CHECKER_WORKFLOW = ".github/workflows/d972-r07-fixed-lambda-cycle-batch-v3.yml"
...
def k128_registration_canary(root: Path) -> dict[str, Any]:
    ...
    for side in ("producer", "checker"):
        ...
        bad[side]["file"] = bad[side]["file"].replace("_v3.py", "_v2.py")
...
def selftest(root: Path) -> dict[str, Any]:
    ...
    return document("selftest", {"status": "PASS", "tests": [first, second],
        "fixture_scope": "new-k128-registration-and-portable-metadata;synthetic-full-54433-rosters;real-saved-payload-reader;all-fixtures-retained;no-accepted-parent-arithmetic",
