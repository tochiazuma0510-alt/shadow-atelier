...
Task945/947. Immutable Task904 + seed30 + seed34 are retained premises.
...
SCHEMA = "d972.r07.fixed-root-packet-loop.v1"
...
def owner_and_tables(m: Any, base: Any, descriptors: Any, args: argparse.Namespace,
    ...
    for parents in state["saved_parents"]:
        require(descriptors.without_roots(p1_parent) == parents["p1"] and
                ...
                parents["rho2"]["target_derivation_accepted_as_premise"] is True,
