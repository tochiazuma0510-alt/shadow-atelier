...
D345Fixture:="search/certs/d972_r07_word_independent_successor_kernel_selftest_v6_20260829.json";;
...
D345Pins:=[
 ...
 [D345Fixture,5026,"f04d8ef01d5b9c1cc9e05f674e6868dae67d7c60b1f51573c5b90c80ca365545"]];;
D345AuthorityPins:=[
...
D345LegacyOwned:=[
 ...
 "ci/out/d972_r07_word_independent_successor_kernel_v4.sh",
 "ci/out/d972_r07_word_independent_successor_kernel_v4.ok",
 "ci/out/d972_r07_word_independent_successor_kernel_v5.json",
 "ci/out/d972_r07_word_independent_successor_kernel_v5.verdict.json",
 "ci/out/d972_r07_word_independent_successor_kernel_v5.sh",
 "ci/out/d972_r07_word_independent_successor_kernel_v5.ok",
 "ci/out/d972_r07_word_independent_successor_kernel_v5.producer.checkpoint.json",
 "ci/out/d972_r07_word_independent_successor_kernel_v5.checker.checkpoint.json"];;
...
if D345Mode="SELFTEST" then
 ...
 PrintTo(D345S,"grep -Fxc 'R07_WORD_INDEPENDENT_SUCCESSOR_KERNEL_V6_PRODUCER_SELFTEST_PASS' ",D345PLog," >/dev/null\n");
 ...
 PrintTo(D345S,"grep -Fxc 'R07_WORD_INDEPENDENT_SUCCESSOR_KERNEL_V6_CHECKER_SELFTEST_PASS' ",D345CLog," >/dev/null\n");
 ...
 PrintTo(D345S,"D345PLine=$(grep -E '^R07_WORD_INDEPENDENT_SUCCESSOR_KERNEL_V6_PRODUCER_TERMINAL (R07_WORD_INDEPENDENT_SUCCESSOR_KERNEL_V6_PASS|UNKNOWN_INPUT|UNKNOWN_RESOURCE)$' ",D345PLog,")\n");
 PrintTo(D345S,"test \"$(grep -Ec '^R07_WORD_INDEPENDENT_SUCCESSOR_KERNEL_V6_PRODUCER_TERMINAL ' ",D345PLog,")\" = 1\n");
 ...
 PrintTo(D345S,"D345CLine=$(grep -E '^R07_WORD_INDEPENDENT_SUCCESSOR_KERNEL_V6_CHECKER_TERMINAL (R07_WORD_INDEPENDENT_SUCCESSOR_KERNEL_V6_PASS|UNKNOWN_INPUT|UNKNOWN_RESOURCE)$' ",D345CLog,")\n");
 PrintTo(D345S,"test \"$(grep -Ec '^R07_WORD_INDEPENDENT_SUCCESSOR_KERNEL_V6_CHECKER_TERMINAL ' ",D345CLog,")\" = 1\n");
