...
if D187Mode="SELFTEST" then
  ...
  PrintTo(D187Stream,"cat ",D187ProducerLog,"\n");
  PrintTo(D187Stream,"printf 'R07_U0V0_BOUNDARY_PREIMAGE_V1_STAGE=producer_process\\n'\n");
  PrintTo(D187Stream,"grep -Fxc 'R07_U0V0_BOUNDARY_PREIMAGE_V1_PRODUCER_SELFTEST_PASS' ",D187ProducerLog," | grep -qx 1\n");
  PrintTo(D187Stream,"printf 'R07_U0V0_BOUNDARY_PREIMAGE_V1_STAGE=producer_marker\\n'\n");
  ...
  PrintTo(D187Stream,"IFS= read -r checker_line < ",D187CheckerLog,"\n");
  PrintTo(D187Stream,"test \"$checker_line\" = 'R07_U0V0_BOUNDARY_PREIMAGE_V1_CHECKER_PASS terminal=R07_U0V0_BOUNDARY_PREIMAGE_V1_SELFTEST_PASS'\n");
  PrintTo(D187Stream,"test \"$(wc -l < ",D187CheckerLog,")\" -eq 1\n");
  ...
  PrintTo(D187Stream,"python3 -u -B ",D187Producer," --mode PRODUCTION --output ",D187Receipt,
    " --seconds 19800 --boundary-pairs 8000000 --retained-columns 250000 --rss-bytes 5700000000 > ",D187ProducerLog," 2>&1\n");
  PrintTo(D187Stream,"cat ",D187ProducerLog,"\n");
  PrintTo(D187Stream,"printf 'R07_U0V0_BOUNDARY_PREIMAGE_V1_STAGE=producer_process\\n'\n");
  ...
  PrintTo(D187Stream,"printf 'R07_U0V0_BOUNDARY_PREIMAGE_V1_STAGE=producer_marker\\n'\n");
  PrintTo(D187Stream,"python3 -u -B ",D187Checker," ",D187Receipt," > ",D187CheckerLog," 2>&1\n");
  PrintTo(D187Stream,"cat ",D187CheckerLog,"\n");
  PrintTo(D187Stream,"printf 'R07_U0V0_BOUNDARY_PREIMAGE_V1_STAGE=checker_process\\n'\n");
  ...
  PrintTo(D187Stream,"printf 'R07_U0V0_BOUNDARY_PREIMAGE_V1_STAGE=terminal_equal\\n'\n");
fi;
PrintTo(D187Stream,"printf 'R07_U0V0_BOUNDARY_PREIMAGE_V1_STAGE=sentinel_write\\n'\n");
