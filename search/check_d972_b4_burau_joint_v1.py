...
PRODUCER_PATH = Path("search/d972_b4_burau_joint_v1.py")
...
def burau(q: int, a: int) -> tuple[Matrix, Matrix, Matrix]:
    require((q, a) in ((3, -1), (4, 2), (5, 2), (5, 4)), "unsupported q/a")
...
def check_receipt(path: Path) -> dict[str, Any]:
    ...
    require(r.get("status") in {"CANDIDATE_B4_A_BURAU_JOINT_ZERO_FIBER",
...
def selftest() -> None:
    ...
    print("D972_B4_BURAU_JOINT_V1_SOURCE_WORD_ROOF_ONLY_NEGATIVE_PASS row=2 exponent=(-4,-8) nonzero=956")
    print("D972_B4_BURAU_JOINT_V1_CHECKER_NEGATIVE_FIXTURES_PASS")
    print("D972_B4_BURAU_JOINT_V1_CHECKER_SELFTEST_PASS")
    print("D972_B4_BURAU_JOINT_V1_CHECKER_FINAL_MARKER status=PASS")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    print("D972_B4_BURAU_JOINT_V1_CHECK_PASS", json.dumps(result, sort_keys=True))
    return 0
