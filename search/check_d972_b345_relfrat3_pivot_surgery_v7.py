#!/usr/bin/env python3
"""Independent checker for pivot-directed fixed-candidate v7.
...
def replay_pivot_surgery(data: dict[str, Any], e4: Quotient,
    ...
    require((data["terminal_token"] ==
             "B345_RELFRAT3_PIVOT_SURGERY_PASS") == passed,
            "directed replay terminal")
...
def self_test_fixed() -> None:
    """Public combined selftest entry: only the active v7 contract."""
    self_test_v7()
...
def main() -> int:
    ...
    print(f"B345_RELFRAT3_PIVOT_SURGERY_V7_CHECKER_PASS "
...
if __name__ == "__main__":
    try:
        ...
        print(f"B345_RELFRAT3_PIVOT_SURGERY_V7_CHECKER_FAIL {exc}", file=sys.stderr)
        raise SystemExit(1)
