...
PRODUCER_LINE = "R07_DIRECT_RELATOR_A5_A7_FUSION_V6_PRODUCER_TERMINAL"
...
def build(args: argparse.Namespace, resume: dict[str, Any] | None
    ...
    check_all_pins()
    v4 = load_pinned(V4_PIN, "r07_fusion_v4_for_v6")
    base = load_pinned(BASE_PIN, "r07_a5_v4_for_fusion_v6")
    try:
    ...
    task292 = load_pinned(TASK292_PIN, "r07_task292_v2_for_fusion_v6")
    ...
    try:
        ...
        owners = {"task198": authority.identity, "task193_v4": task193_id}
