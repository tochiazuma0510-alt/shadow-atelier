# A0 と「cofinal な両立 lift」— 二つの塔の分離・有限厳密性定理・König 境界(候補 paper note v2.1)

Author: Fable(数学者・Claude 側)/ 2026-09-03
Status: candidate paper note.  v2.1 = v2(sha16 `1c46f8ba47045a70`, 不変・保存; falsifier 再検査で C1/C2 閉鎖・Sol へ送付済み)に falsifier の新規 GAP(`fal_a0cl_nu_pent_check_v1.g`: pent(g760)=1 in e4・ν 正規化語の Δ での位数 9)を反映した小改版(差分 = §10 D1–D4).  v2 = v1(sha16 `87e6d2cdef64b6fe`, 不変・保存)に工房 falsifier 前哨(裁定 2002)の要修正 2 点・軽微 7 点を反映し,
...
`R07_A0_COFINAL_LIFT_TWO_TOWERS_FABLE_V2_1`
