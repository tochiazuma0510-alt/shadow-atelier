# $N_\infty$ searcher — **stage 2 述語の仕様(spec v15・自己完結版)**

2026-07-28 起草: Claude(数学者レイヤー・Opus 5)。**司令塔委嘱(裁定 91)。**
...
```text
predicate_spec_id     = "mb/ninfty-stage2-predicate/v15"
...
verifier_contract_id     = "mb/ninfty-verifier-contract/v10"
verifier_contract_digest = 4453b5d199a5683a02bb2df7d13ee423f7461bb075e6970d74ab427ce4367fd6
dependency_manifest_schema_id     = "mb/dependency-manifest/v10"
dependency_manifest_schema_digest = 1bb24aa10179a4bf05c7432c2af8e28de4f0836b70b78395305d37aa233c6044
...
```text
exact_freeze_bundle = {
  predicate_spec_id     = "mb/ninfty-stage2-predicate/v15",    predicate_spec_digest,
  verifier_contract_id  = "mb/ninfty-verifier-contract/v10",    verifier_contract_digest,
  dependency_manifest_schema_id = "mb/dependency-manifest/v10",  dependency_manifest_schema_digest
}
...
```text
live_authority_refs[] = [
  { artifact_id: "mb/ninfty-verifier-contract/v10",
    digest_or_receipt_slot: "4453b5d199a5683a02bb2df7d13ee423f7461bb075e6970d74ab427ce4367fd6",
    anchor: "§3.1 / §3.1.2 witness kinds, §3.4 result-vector, §5.1 two-axis" },
  { artifact_id: "mb/dependency-manifest/v10",
    digest_or_receipt_slot: "1bb24aa10179a4bf05c7432c2af8e28de4f0836b70b78395305d37aa233c6044",
...
historical_quotation_refs[] = [
  { artifact_id: "mb/ninfty-stage2-predicate/v5..v14", note: "版履歴・差分表・自認文のみ" },
  { artifact_id: "mb/ninfty-verifier-contract/v1..v9", note: "差分表・自認文のみ" },
  { artifact_id: "mb/dependency-manifest/v1..v9",      note: "差分表・自認文のみ" }
]
```
