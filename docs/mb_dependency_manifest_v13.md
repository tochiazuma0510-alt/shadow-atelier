# `mb/dependency-manifest/v13` — implementation dependency closure の記録様式

2026-07-28 起草: Claude(数学者レイヤー・Opus 5)。**司令塔委嘱(自動ループ 2 巡)。前版を supersede。**
...
governing_spec = "mb/ninfty-stage2-predicate/v18"
governing_spec_digest = <64 hex: governing spec の digest — receipt が記入>
supersedes    = "mb/dependency-manifest/v12"
supersedes_digest = 5c13e5c3f4101492fd414d48eb10d8b37e7d639162c46a05bb35165d203f22f0   # Sol 便 74 FAIL (B74-1/2/3)
...
historical_quotation_refs[] = [
  { artifact_id: "mb/dependency-manifest/v1..v12",     note: "版履歴・差分表・自認文のみ" },
  { artifact_id: "mb/ninfty-verifier-contract/v1..v12", note: "差分表・自認文のみ" },
  { artifact_id: "mb/ninfty-stage2-predicate/v5..v17", note: "差分表・自認文のみ" }
]
```
