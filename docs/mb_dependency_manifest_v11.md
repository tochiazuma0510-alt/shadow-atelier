# `mb/dependency-manifest/v11` — implementation dependency closure の記録様式

2026-07-28 起草: Claude(数学者レイヤー・Opus 5)。**司令塔委嘱(裁定 93)。前版を supersede。**
...
```text
schema_id     = "mb/dependency-manifest/v11"
schema_digest = <64 hex: 本稿 exact blob の sha256 — receipt が記入>
encoding      = UTF-8, LF, no BOM, no normalization
governing_spec = "mb/ninfty-stage2-predicate/v16"
governing_spec_digest = <64 hex: governing spec の digest — receipt が記入>
supersedes    = "mb/dependency-manifest/v10"
supersedes_digest = 1bb24aa10179a4bf05c7432c2af8e28de4f0836b70b78395305d37aa233c6044   # Sol 便 71 FAIL (B71-2/3/5)
...
historical_quotation_refs[] = [
  { artifact_id: "mb/dependency-manifest/v1..v10",     note: "版履歴・差分表・自認文のみ" },
  { artifact_id: "mb/ninfty-verifier-contract/v1..v10", note: "差分表・自認文のみ" },
  { artifact_id: "mb/ninfty-stage2-predicate/v5..v15", note: "差分表・自認文のみ" }
]
```
...
sweep_definition = {                      # [sweep-def] 現行有効
  ...
  current_version = "v11",
  historical_upper_bound = "v10",   # = current - 1(script v3 が自動照合)
