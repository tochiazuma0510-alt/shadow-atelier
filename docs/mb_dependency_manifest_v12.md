# `mb/dependency-manifest/v12` — implementation dependency closure の記録様式

2026-07-28 起草: Claude(数学者レイヤー・Opus 5)。**司令塔委嘱(裁定 97)。前版を supersede。**
...
```text
schema_id     = "mb/dependency-manifest/v12"
schema_digest = <64 hex: 本稿 exact blob の sha256 — receipt が記入>
encoding      = UTF-8, LF, no BOM, no normalization
governing_spec = "mb/ninfty-stage2-predicate/v17"
governing_spec_digest = <64 hex: governing spec の digest — receipt が記入>
supersedes    = "mb/dependency-manifest/v11"
supersedes_digest = be6c288f8e123a3ebf9e6d7b6696d67017607ab65b3d15e5b718c7a77e8e7bfe   # Sol 便 72 FAIL (B72-1/2)
...
historical_quotation_refs[] = [
  { artifact_id: "mb/dependency-manifest/v1..v11",     note: "版履歴・差分表・自認文のみ" },
  { artifact_id: "mb/ninfty-verifier-contract/v1..v11", note: "差分表・自認文のみ" },
  { artifact_id: "mb/ninfty-stage2-predicate/v5..v16", note: "差分表・自認文のみ" }
]
```
