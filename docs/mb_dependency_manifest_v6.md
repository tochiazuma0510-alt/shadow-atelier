# `mb/dependency-manifest/v6` — implementation dependency closure の記録様式
...
```text
schema_id     = "mb/dependency-manifest/v6"
...
supersedes    = "mb/dependency-manifest/v5"
supersedes_digest = 46150ba03ae02c340431fe3a162d2925b7b7a5b8fcf55dca76fd2c6c5e351df8   # 内部ゲート差戻し (falsifier FINDING-1)
...
conformance_record = {
  ...
  covered_clauses = [BA-1, BA-2, BA-3, BA-4, BA-5, CR-1, CR-2, CR-2′, CR-3, CR-5, CR-6, CR-7, 
                     ...
                     SB-3′, SB-4, SB-5, SB-6, T-1″, T-2′, T-3, T-4, Y-1, Y-2, Y-3, Y-4, Y-4a, 
                     Y-4b, Y-4c, Y-4d]
  covered_procedure_checks = [C1, D-1, D-2, D-3, D-4, D-4′, S1, S2, S3, U-1, U-2, U-3, U-4, W-2]
  uncovered_checks = []
  uncovered_clauses = []
}
```
...
> **[historical] LA-3**: sweep の対象定義**: 自 artifact の全版 token("manifest v1..v5"/`mb/dependency-manifest/v*`)と、**他 2 文書の全版 token**("spec v5..v10"/`mb/ninfty-stage2-predicate/v*`・"contract v1..v5"/`mb/ninfty-verifier-contract/v*`)。
