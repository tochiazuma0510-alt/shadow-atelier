...
- **【GAP-D0】ほぼ閉鎖**: 「G = ∐G_i 自由副有限積 ⇒ G_i ∩ G_j^g = 1(i ≠ j または g ∉ G_j)」= **Ribes–Zalesskii (Springer 2000) Thm 9.1.12**(+隣接 9.5.1)。逐語出典: 0712.4244 Thm 2.9(逐語引用・papers/delivered に現物)・1711.01500 p.13 — 2 独立ソース同番号。札: 原本未達(二次確認)・2010 第 2 版の番号異同未確認。
