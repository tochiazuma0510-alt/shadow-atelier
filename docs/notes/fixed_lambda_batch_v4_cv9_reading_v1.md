...
**裁定 2224 訂正(v5 判読より)**: 本判読 §1.1 の「accepted target-derivation parents 225」は v3 の値であり、v4 自身は **353**(v5 run の parent-intake が両方を別 field で記録・累積則 97 → 225 → 353 → 481)。他の結論に影響なし。
