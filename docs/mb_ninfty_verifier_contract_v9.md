# `mb/ninfty-verifier-contract/v9` — divisor equality certificate の検査契約

2026-07-28 起草: Claude(数学者レイヤー・Opus 5)。**司令塔委嘱(裁定 89)。前版を supersede。**
...
supersedes        = "mb/ninfty-verifier-contract/v8"
supersedes_digest = 6f101d3ea245177a7a55a6a97aa746f1526991b5e62837f3e269fd1221da02d8   # Sol 便 70 FAIL (B70-2/3/4)
...
conformance_record = {
  ...
  covered_clauses = [C-1″, C-2, C-3‴, C-4‴, C-5‴, C-6⁗, C-7, C-8‴, C-9, CR-1, CR-10, CR-11, CR-2, 
                     CR-3, CR-4, CR-5, CR-6, CR-7, CR-8, CR-9, LA-1, LA-2, LA-3, P-S1, P-S2, 
                     P-S3, P-S4, P-S5, P-S6, R-1, R-2, R-3, V-0, V-1, V-2, V-3, W-1, W-3, W-4, 
                     W-5, W-6, X-1, X-2, X-3, X-4, X-5, X-6, Y-1, Y-2, Y-3, Y-4]
  covered_procedure_checks = [C1, D-1, D-2, D-3, D-4′, P-0.1, P-0.2, P-0.3, P-0.4, P-0.5, P-0.6, 
                              ...
                              P-3.3, R-1, R-2, R-3, R-6, S1, S2, S3, U-1, U-4, W-1, W-2, W-2′, 
                              W-3, W-4, W-5, W-6]
  uncovered_checks = []
  uncovered_clauses = []
}
...
historical_quotation_refs[] = [
  { artifact_id: "mb/ninfty-verifier-contract/v9", digest: "703fb47f...(supersedes)" },
  { artifact_id: "mb/ninfty-verifier-contract/v9", digest: "bd4d5064...(supersedes)" },
  { artifact_id: "mb/ninfty-verifier-contract/v9", digest: "1fd36b3e...(supersedes)" },
...
sweep_definition = {                      # [sweep-def] 現行有効
  ...
  current_version = "v9",
  historical_upper_bound = "v8",   # = current - 1(script v3 が自動照合)
