# `mb/ninfty-verifier-contract/v10` — divisor equality certificate の検査契約
...
```text
contract_id     = "mb/ninfty-verifier-contract/v10"
...
supersedes        = "mb/ninfty-verifier-contract/v9"
supersedes_digest = e3749fda2d72b49fc46e4d55658c12d89ee9bcb5b2041111a2ac2257396838a5   # 内部前哨ゲート第 3 巡 (FINDING 1/2/3)
...
historical_quotation_refs[] = [
  { artifact_id: "mb/ninfty-verifier-contract/v1..v9", note: "版履歴・差分表・自認文のみ" },
  { artifact_id: "mb/dependency-manifest/v1..v9",      note: "差分表・自認文のみ" },
  { artifact_id: "mb/ninfty-stage2-predicate/v5..v14", note: "§0.2 差分表・§8 erratum 記録のみ" }
]
```
