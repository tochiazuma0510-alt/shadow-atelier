...
## 追補(司令塔・arXiv API 直叩き・同日)

残 UNKNOWN(系譜著者の直近投稿)を API で閉鎖: **V.A. Dolgushev の最新投稿 = 2405.11725(2024-05)・以後ゼロ**。共著者 6 名(Bortnovskyi・Holikov・Pashkovskyi・Guynee・Le・Lorenz)も同名別人を除き GT-shadows の新作なし(Holikov→エルゴード理論 2026-07・Bortnovskyi→組合せ論 2025・Le→3 次元多様体論 2026-03)。**系譜全体でこの主題の新規投稿は 2024-05 以降ゼロ — 先行リスクは一次ソースで否定**。教訓: Scholar/大学ページでなく arXiv API 著者クエリが正路(bot 開放・権威的)。
