# $N_\infty$ searcher — **stage 2 述語の仕様(spec v19・自己完結版)**
...
erratum_scope_v19 = { integrity_priority [27] 追加 (P), semantic axis S2 帯拡張, contract v14 pin }
...
```text
predicate_spec_id     = "mb/ninfty-stage2-predicate/v19"
...
```text
exact_freeze_bundle = {
  predicate_spec_id     = "mb/ninfty-stage2-predicate/v19",    predicate_spec_digest,
  verifier_contract_id  = "mb/ninfty-verifier-contract/v14",    verifier_contract_digest,
  dependency_manifest_schema_id = "mb/dependency-manifest/v14",  dependency_manifest_schema_digest
}
...
historical_quotation_refs[] = [
  { artifact_id: "mb/ninfty-stage2-predicate/v5..v18", note: "版履歴・差分表・自認文のみ" },
  { artifact_id: "mb/ninfty-verifier-contract/v1..v13", note: "差分表・自認文のみ" },
...
sweep_definition = {                      # [sweep-def] 現行有効
  ...
  current_version = "v19",
  historical_upper_bound = "v18",   # = current - 1(script v3 が自動照合)
