# $N_\infty$ searcher — **stage 2 述語の仕様(spec v14・自己完結版)**

2026-07-28 起草: Claude(数学者レイヤー・Opus 5)。**司令塔委嘱(裁定 89)。**
...
```text
predicate_spec_id     = "mb/ninfty-stage2-predicate/v14"
...
verifier_contract_id     = "mb/ninfty-verifier-contract/v9"
verifier_contract_digest = e3749fda2d72b49fc46e4d55658c12d89ee9bcb5b2041111a2ac2257396838a5
dependency_manifest_schema_id     = "mb/dependency-manifest/v9"
dependency_manifest_schema_digest = 5a7da84c3ff076e10a164827158ecfc6d5832ba72dfaf8fb43f670d4db70ff12
...
```text
exact_freeze_bundle = {
  predicate_spec_id     = "mb/ninfty-stage2-predicate/v14",    predicate_spec_digest,
  verifier_contract_id  = "mb/ninfty-verifier-contract/v9",    verifier_contract_digest,
  dependency_manifest_schema_id = "mb/dependency-manifest/v9",  dependency_manifest_schema_digest
}
...
```text
live_authority_refs[] = [
  { artifact_id: "mb/ninfty-verifier-contract/v9",
    digest_or_receipt_slot: "e3749fda2d72b49fc46e4d55658c12d89ee9bcb5b2041111a2ac2257396838a5",
    anchor: "§3.1 / §3.1.2 witness kinds, §3.4 result-vector, §5.1 two-axis" },
  { artifact_id: "mb/dependency-manifest/v9",
    digest_or_receipt_slot: "5a7da84c3ff076e10a164827158ecfc6d5832ba72dfaf8fb43f670d4db70ff12",
    anchor: "#input-separation, #derivation, §2.4 subject binding, §6 intersections" },
  { artifact_id: "mb/ninfty-stage2-predicate/v14",
