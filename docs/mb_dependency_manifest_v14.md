# `mb/dependency-manifest/v14` — implementation dependency closure の記録様式
...
```text
schema_id     = "mb/dependency-manifest/v14"
...
supersedes    = "mb/dependency-manifest/v13"
supersedes_digest = df59b25f75e8e48a4607ed39177e5aa15be5a3fd4c738391aec347d8f7c1cb3e   # 便95 W95-2.3 起点(pin 同期・内容無改定)
...
historical_quotation_refs[] = [
  { artifact_id: "mb/dependency-manifest/v1..v13",     note: "版履歴・差分表・自認文のみ" },
  { artifact_id: "mb/ninfty-verifier-contract/v1..v13", note: "差分表・自認文のみ" },
  { artifact_id: "mb/ninfty-stage2-predicate/v5..v18", note: "差分表・自認文のみ" }
]
```
