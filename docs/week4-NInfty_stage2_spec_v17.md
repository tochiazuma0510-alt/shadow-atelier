# $N_\infty$ searcher — **stage 2 述語の仕様(spec v17・自己完結版)**

2026-07-28 起草: Claude(数学者レイヤー・Opus 5)。**司令塔委嘱(裁定 97)。**

> **[historical]** **【版履歴】本版 = 前版の同期。** 起点は **内部前哨ゲート(falsifier)の第 2 巡**(cross-document 同期類型)。変更は **2 点** — **(L) contract / manifest の新版 pin と §9 exact_freeze_bundle の更新**・**(M) §10 `live_authority_refs[]` の label—digest 対応の点検**(script v3 の check #13 が機械照合)。**数学核・入口契約・lane・certificate・二軸 routing は前版と逐語同一。**
...
```
> **[historical]** **段数**: `[9]`–`[26]` で $26-9+1=18$。**v5 の「16 段」は表題 typo。自認。**
...
```text
predicate_spec_id     = "mb/ninfty-stage2-predicate/v17"
...
verifier_contract_id     = "mb/ninfty-verifier-contract/v12"
verifier_contract_digest = 1eda4fb28e367d03b0655888df301e0064d033dbd274cc9651ab7dfe49692d89
dependency_manifest_schema_id     = "mb/dependency-manifest/v12"
dependency_manifest_schema_digest = 5c13e5c3f4101492fd414d48eb10d8b37e7d639162c46a05bb35165d203f22f0
...
```text
exact_freeze_bundle = {
  predicate_spec_id     = "mb/ninfty-stage2-predicate/v17",    predicate_spec_digest,
  verifier_contract_id  = "mb/ninfty-verifier-contract/v12",    verifier_contract_digest,
  dependency_manifest_schema_id = "mb/dependency-manifest/v12",  dependency_manifest_schema_digest
}
...
```text
live_authority_refs[] = [
  { artifact_id: "mb/ninfty-verifier-contract/v12",
    digest_or_receipt_slot: "1eda4fb28e367d03b0655888df301e0064d033dbd274cc9651ab7dfe49692d89",
    anchor: "§3.1 / §3.1.2 witness kinds, §3.4 result-vector, §5.1 two-axis" },
  { artifact_id: "mb/dependency-manifest/v12",
    digest_or_receipt_slot: "5c13e5c3f4101492fd414d48eb10d8b37e7d639162c46a05bb35165d203f22f0",
    anchor: "#input-separation, #derivation, §2.4 subject binding, §6 intersections" },
  { artifact_id: "mb/ninfty-stage2-predicate/v17",
    digest_or_receipt_slot: "receipt:predicate_spec_digest",
    anchor: "self" }
]

historical_quotation_refs[] = [
  { artifact_id: "mb/ninfty-stage2-predicate/v5..v16", note: "版履歴・差分表・自認文のみ" },
  { artifact_id: "mb/ninfty-verifier-contract/v1..v11", note: "差分表・自認文のみ" },
  { artifact_id: "mb/dependency-manifest/v1..v11",      note: "差分表・自認文のみ" }
]
```
...
sweep_definition = {                      # [sweep-def] 現行有効
  ...
  current_version = "v17",
  historical_upper_bound = "v16",   # = current - 1(script v3 が自動照合)
