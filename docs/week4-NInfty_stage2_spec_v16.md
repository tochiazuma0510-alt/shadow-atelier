# $N_\infty$ searcher — **stage 2 述語の仕様(spec v16・自己完結版)**

2026-07-28 起草: Claude(数学者レイヤー・Opus 5)。**司令塔委嘱(裁定 93)。**
...
```text
predicate_spec_id     = "mb/ninfty-stage2-predicate/v16"
...
verifier_contract_id     = "mb/ninfty-verifier-contract/v11"
verifier_contract_digest = 1bd29823c3e12271baf2331d36a04aaed25fe4916a3f931f767cf513c2031285
dependency_manifest_schema_id     = "mb/dependency-manifest/v11"
dependency_manifest_schema_digest = be6c288f8e123a3ebf9e6d7b6696d67017607ab65b3d15e5b718c7a77e8e7bfe
...
```text
exact_freeze_bundle = {
  predicate_spec_id     = "mb/ninfty-stage2-predicate/v16",    predicate_spec_digest,
  verifier_contract_id  = "mb/ninfty-verifier-contract/v11",    verifier_contract_digest,
  dependency_manifest_schema_id = "mb/dependency-manifest/v11",  dependency_manifest_schema_digest
}
...
```text
live_authority_refs[] = [
  { artifact_id: "mb/ninfty-verifier-contract/v11",
    digest_or_receipt_slot: "1bd29823c3e12271baf2331d36a04aaed25fe4916a3f931f767cf513c2031285",
    anchor: "§3.1 / §3.1.2 witness kinds, §3.4 result-vector, §5.1 two-axis" },
  { artifact_id: "mb/dependency-manifest/v11",
    digest_or_receipt_slot: "be6c288f8e123a3ebf9e6d7b6696d67017607ab65b3d15e5b718c7a77e8e7bfe",
    anchor: "#input-separation, #derivation, §2.4 subject binding, §6 intersections" },
  { artifact_id: "mb/ninfty-stage2-predicate/v16",
    digest_or_receipt_slot: "receipt:predicate_spec_digest",
    anchor: "self" }
]

historical_quotation_refs[] = [
  { artifact_id: "mb/ninfty-stage2-predicate/v5..v15", note: "版履歴・差分表・自認文のみ" },
  { artifact_id: "mb/ninfty-verifier-contract/v1..v10", note: "差分表・自認文のみ" },
  { artifact_id: "mb/dependency-manifest/v1..v10",      note: "差分表・自認文のみ" }
]
```
...
sweep_definition = {                      # [sweep-def] 現行有効
  ...
  current_version = "v16",
  historical_upper_bound = "v15",   # = current - 1(script v3 が自動照合)
