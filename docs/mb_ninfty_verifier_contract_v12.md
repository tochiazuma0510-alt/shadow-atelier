# `mb/ninfty-verifier-contract/v12` — divisor equality certificate の検査契約
...
```text
contract_id     = "mb/ninfty-verifier-contract/v12"
...
supersedes        = "mb/ninfty-verifier-contract/v11"
supersedes_digest = 1bd29823c3e12271baf2331d36a04aaed25fe4916a3f931f767cf513c2031285   # Sol 便 72 (pin 同期)
...
historical_quotation_refs[] = [
  { artifact_id: "mb/ninfty-verifier-contract/v1..v11", note: "版履歴・差分表・自認文のみ" },
  { artifact_id: "mb/dependency-manifest/v1..v11",      note: "差分表・自認文のみ" },
  { artifact_id: "mb/ninfty-stage2-predicate/v5..v16", note: "§0.2 差分表・§8 erratum 記録のみ" }
]
```
