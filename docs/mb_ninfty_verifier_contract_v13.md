# `mb/ninfty-verifier-contract/v13` — divisor equality certificate の検査契約
...
supersedes        = "mb/ninfty-verifier-contract/v12"
supersedes_digest = 1eda4fb28e367d03b0655888df301e0064d033dbd274cc9651ab7dfe49692d89   # Sol 便 74 (pin 同期)
...
historical_quotation_refs[] = [
  { artifact_id: "mb/ninfty-verifier-contract/v1..v12", note: "版履歴・差分表・自認文のみ" },
  { artifact_id: "mb/dependency-manifest/v1..v12",      note: "差分表・自認文のみ" },
  { artifact_id: "mb/ninfty-stage2-predicate/v5..v17", note: "§0.2 差分表・§8 erratum 記録のみ" }
]
```
