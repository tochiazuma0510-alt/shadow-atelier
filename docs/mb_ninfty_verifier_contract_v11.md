# `mb/ninfty-verifier-contract/v11` — divisor equality certificate の検査契約
...
```text
contract_id     = "mb/ninfty-verifier-contract/v11"
...
supersedes        = "mb/ninfty-verifier-contract/v10"
supersedes_digest = 4453b5d199a5683a02bb2df7d13ee423f7461bb075e6970d74ab427ce4367fd6   # Sol 便 71 FAIL (B71-2/3)
...
historical_quotation_refs[] = [
  { artifact_id: "mb/ninfty-verifier-contract/v1..v10", note: "版履歴・差分表・自認文のみ" },
  { artifact_id: "mb/dependency-manifest/v1..v10",      note: "差分表・自認文のみ" },
  { artifact_id: "mb/ninfty-stage2-predicate/v5..v15", note: "§0.2 差分表・§8 erratum 記録のみ" }
]
```
