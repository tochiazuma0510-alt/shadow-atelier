# $N_\infty$ searcher — **stage 2 述語の仕様(spec v18・自己完結版)**

2026-07-28 起草: Claude(数学者レイヤー・Opus 5)。**司令塔委嘱(自動ループ 2 巡)。**
...
```text
exact_freeze_bundle = {
  predicate_spec_id     = "mb/ninfty-stage2-predicate/v18",    predicate_spec_digest,
  verifier_contract_id  = "mb/ninfty-verifier-contract/v13",    verifier_contract_digest,
  dependency_manifest_schema_id = "mb/dependency-manifest/v13",  dependency_manifest_schema_digest
}
...
```text
live_authority_refs[] = [
  { artifact_id: "mb/ninfty-verifier-contract/v13",
    digest_or_receipt_slot: "e41d51dbdbdcf66efaff2ccd073bbfba9bff12bbfff435ca290a4248abcf5022",
    anchor: "§3.1 / §3.1.2 witness kinds, §3.4 result-vector, §5.1 two-axis" },
  { artifact_id: "mb/dependency-manifest/v13",
    digest_or_receipt_slot: "df59b25f75e8e48a4607ed39177e5aa15be5a3fd4c738391aec347d8f7c1cb3e",
    anchor: "#input-separation, #derivation, §2.4 subject binding, §6 intersections" },
  { artifact_id: "mb/ninfty-stage2-predicate/v18",
    digest_or_receipt_slot: "receipt:predicate_spec_digest",
    anchor: "self" }
]

historical_quotation_refs[] = [
  { artifact_id: "mb/ninfty-stage2-predicate/v5..v17", note: "版履歴・差分表・自認文のみ" },
  { artifact_id: "mb/ninfty-verifier-contract/v1..v12", note: "差分表・自認文のみ" },
...
sweep_definition = {                      # [sweep-def] 現行有効
  ...
  current_version = "v18",
  historical_upper_bound = "v17",   # = current - 1(script v3 が自動照合)
