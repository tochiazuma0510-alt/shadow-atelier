# `mb/dependency-manifest/v9` — implementation dependency closure の記録様式
...
```text
schema_id     = "mb/dependency-manifest/v9"
...
supersedes    = "mb/dependency-manifest/v8"
supersedes_digest = 554aa71071469866d18346fc50af06d2a5a04204072471be7eb5d78d66616fa9   # Sol 便 70 FAIL (B70-1/2)
...
conformance_record = {
  ...
  covered_clauses = [BA-1, BA-2, BA-3, BA-4, BA-5, BC-1, BC-2, BC-3, CR-1, CR-10, CR-11, CR-2, 
                     CR-2′, CR-3, CR-5, CR-6, CR-7, CR-8, CR-9, D-R1, D-R2⁗, D-R3, D-R4, E-1, 
                     E-10′, E-1′, E-2, E-2′, E-3, E-4, E-5, E-6, E-7‴, E-8″, E-9′, FA-1, FA-2, 
                     ...
                     LA-3, M-1′, M-2′, M-3′, M-4, M-5, QD-1, QD-2, QD-3, QD-4, QD-5′, QD-6, QD-7, 
                     SB-1′, SB-2′, SB-3′, SB-4, SB-5, SB-6, SB-7, T-1″, T-2′, T-3, T-4, Y-1, Y-2, 
                     Y-3, Y-4, Y-4a, Y-4b, Y-4c, Y-4d]
  covered_procedure_checks = [C1, D-1, D-2, D-3, D-4′, R-1, R-2, R-3, R-4, R-5, R-6, S1, S2, S3, 
                              U-1, U-2, U-3, U-4, W-2′]
  uncovered_checks = []
  uncovered_clauses = []
}
...
historical_quotation_refs[] = [
  { artifact_id: "mb/dependency-manifest/v9", digest: "378f30c8...(supersedes)" },
  { artifact_id: "mb/dependency-manifest/v9", digest: "1a8d1f21...(supersedes)" },
  { artifact_id: "mb/dependency-manifest/v9", note: "§0.1 差分表の引用のみ" }
]
```
