...
- Exit code: 0.
- Checker terminal row: `P1_AXIOM_AUDIT_PASS|modules=8|theorems=180|manifest=P1/AXIOMS.manifest.json`.
...
Main theorem receipt (the generated manifest is the complete 180-row receipt):
